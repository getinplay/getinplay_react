  ...
  return (
    <>
      <div className="relative active:bg-gray-100 duration-300 hover:bg-gray-50 inset-shadow-black shadow-xl hover:scale-[1.05] select-none cursor-pointer border-gray-300 border-1 w-full rounded-lg sm:p-3 p-2 sm:gap-2 gap-1 flex flex-col justify-center items-center">
        ...
        {popular ? (
          <div className="sm:text-base text-sm absolute bg-red-600 px-3 py-1 rounded-2xl right-2.5 text-white top-[-12px]">
            Popular
          </div>
        ) : null}
        <Link
          to={"/membership"}
          viewTransition
          className="sm:text-base text-sm duration-200 active:bg-red-600 bg-white active:text-white hover:bg-red-600 hover:text-white border-1 border-gray-300 my-3 px-3 py-1 rounded-md cursor-pointer">
          View Plans
        </Link>
      </div>
    </>
