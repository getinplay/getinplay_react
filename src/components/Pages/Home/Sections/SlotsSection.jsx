  ...
  return (
    <div className='flex flex-col items-center justify-center w-[80vw]'>
      ...
      <div className='flex items-center justify-center gap-2 w-full py-3'>
        <button
          type='button'
          className='flex items-center justify-center cursor-pointer active:text-gray-200 duration-200 z-20 custom-prev-2'>
        ...
        <button
          type='button'
          className='flex items-center justify-center cursor-pointer active:text-gray-200 duration-200 z-20 custom-next-2'>
