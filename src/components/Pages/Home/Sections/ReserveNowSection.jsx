    ...
    <>
      <div className='flex justify-center'>
        <div className='lg:w-max min-h-[500px] pt-10 pb-20 flex flex-col-reverse lg:flex-row items-center justify-center'>
          <div className='lg:w-[40svw] w-[80svw] flex flex-col justify-between items-start pl-5 max-lg:rounded-b-xl lg:rounded-l-xl h-full bg-red-600 p-5 '>
            ...
            <Link
              to='/login'
              className='hover:bg-gray-200 duration-300 active:translate-y-2 active:shadow-none shadow-lg shadow-red-300 cursor-pointer text-base sm:text-lg text-red-600 bg-white font-semibold rounded-lg px-3 sm:px-5 py-1 sm:py-2'>
              Join for free
            </Link>
          </div>
