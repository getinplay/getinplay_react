...
function ContactUsPage() {
  return (
    <div className='flex flex-col justify-between items-center w-full font-semibold'>
      <h1 className='text-5xl p-3 font-bold text-gray-800'>Contact Us</h1>
      <div className='flex grow lg:w-[1000px] p-3 mb-3'>
        <form
          className='flex flex-col grow h-max gap-3 border-4 border-gray-700 rounded-xl p-5 justify-center overflow-auto text-3xl'
