...
function GamesCard({ children, src, half, full, gameId }) {
  return (
    <div>
      <Link
        to={gameId}
        className='group select-none hover:shadow-[0_3px_10px_rgb(150,150,150)] border border-gray-200 bg-white flex flex-col active:bg-gray-100 hover:bg-gray-100 cursor-pointer active:scale-[1.08] hover:-translate-y-1 duration-300 gap-2 lg:w-[250px] sm:w-[225px] xs:w-[200px] max-xs:max-w-[300px] h-[300px] xs:h-[300px] sm:h-[325px] lg:h-[350px] rounded-lg overflow-hidden'>
