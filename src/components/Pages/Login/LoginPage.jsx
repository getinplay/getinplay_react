        ...
        <form
          ...
          <div className='flex flex-col pt-2 items-center justify-center w-full gap-3 sm:text-lg font-medium text-gray-600'>
            ...
            <div className='w-5/6 flex justify-between select-none px-1 flex-col xs:flex-row xs:gap-y-0 gap-y-2'>
              ...
              <Link
                to={"/forgot-password"}
                className='hover:text-[#4A5BE6] text-end'
                viewTransition>
                Forgot password?
              </Link>
            </div>
          ...
          <button
            type='submit'
            className='mb-5 cursor-pointer bg-[#4A5BE6] p-2 rounded-lg tracking-wide text-white font-bold sm:text-lg active:translate-y-2 active:shadow-none duration-300 shadow-gray-400 hover:shadow-xl shadow-lg w-5/6'>
            LOGIN
          </button>
        </form>
      </div>
