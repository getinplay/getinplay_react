...
function Navbar() {
  ...
  return (
    <>
      <div className="relative flex w-svw px-5 max-sm:px-1 items-center justify-between border-b-1 border-gray-200">
        ...
        <div className={`${showNav ? "max-lg:right-0 max-lg:opacity-100" : "max-lg:right-[-100%] max-lg:opacity-0 "} lg:relative max-lg:px-10 absolute max-lg:top-10 h-max w-full duration-1000 ease-in-out z-10`}>
        ...
        <div className="flex items-center text-md font-semibold z-20 ">
          ...
          <button onClick={() => {
            ...
            <FontAwesomeIcon icon={faBars} className="px-2 pr-6  cursor-pointer lg:!hidden" />
          </button>
        </div>
      </div >
    </>
