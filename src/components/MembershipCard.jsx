...
function MembershipCard({ children, rate, popular, onlineAccess }) {
  return (
    <>
      <div className='relative hover:bg-gray-100 select-none cursor-pointer border-gray-300 border-1 w-full rounded-lg p-3 gap-2 flex flex-col justify-center items-center'>
        <h4
        ...
        <button className='hover:bg-red-500 hover:text-white border-1 border-gray-300 my-3 px-3 py-1 rounded-md cursor-pointer'>
          View Plans
        </button>
      </div>
    </>
